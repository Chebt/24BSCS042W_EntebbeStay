...
('Best Western Premier', 4, 'Manyago (Near Victoria Mall)',
 'Pool, Gym, Spa, WiFi', 25, 'https://bestwesternghe.co.ug', 'images/BWP_Hotel.jpg'),
('K Hotels Entebbe', 4, 'Hill Road', 'Rooftop Lounge, Spa, Gym, WiFi, 
Bar & Restaurant', 23, 'https://www.khotels.ug', 'images/K_Hotels.jpg'),
...
Rooftop Terrace, Pool', 32, 'http://www.imperialhotels.co.ug', 'images/ImperialHeights.jpg'),
('Executive Airport Hotel', 3, 'Kamuli Road (Kitoro)', 'Free WiFi, 
Garden, Shuttle, Restaurant', 22, 'https://www.booking.com', 'images/Executive_Airport.jpg'),
('Psalms Motel', 3, 'Fulu Road (Kitoro)', 'Bar, Restaurant, 
Executive Room Service, WiFi', 17, 'http://www.psalmsmotelentebbe.com', 'images/PsalmsMotel.jpg'),
...
('Ambrosia Heights', 3, 'Kitoro Center', 'AC, Outdoor Bar, Garden,
 Ragae Nights', 19, 'https://www.expedia.com', 'images/AmbrosiaHeights.jpg'),
('Hotel Dot Com', 2, 'Kitoro Market Area', 'Budget Friendly, Restaurant, 
Room Service', 15, 'https://www.agoda.com', 'images/HotelDotCom.jpg'),
('Lakeside Resort', 3, 'Kawuku Bugiri', 'Lake View, Quiet, Security, 
Garden', 20, 'https://responsibletourismcompany.com', 'images/LakesideResort.jpg');
